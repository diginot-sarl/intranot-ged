        ...
        if (
          ...
          if (
            ...
            this.toastService.show({
              content: $localize`Document ${status.filename} was added to Intranot GED.`,
              delay: 10000,
    ...
    this.tourService.initialize(
      [
        ...
        },
        {
          ...
          content: $localize`Drag-and-drop documents here to start uploading or place them in the consume folder. You can also drag-and-drop documents anywhere on all other pages of the web app. Once you do, Intranot GED will start training its machine learning algorithms.`,
          route: '/dashboard',
        },
        {
        ...
        },
        {
          ...
          content:
            ...
            '<br/><br/>' +
            $localize`Lastly, on behalf of every contributor to this community-supported project, thank you for using Intranot GED!`,
          route: '/dashboard',
          isOptional: false,
          backdropConfig: {
            offset: 0,
